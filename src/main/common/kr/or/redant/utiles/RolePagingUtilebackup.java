...
// 페이지네이션 UI 작성
public class RolePagingUtilebackup {
	...
	public RolePagingUtilebackup(HttpServletRequest request, int totalCount, int currentPage) {
	...
	public RolePagingUtilebackup(HttpServletRequest request, int totalCount, int currentPage, String search_keycode,String search_keyword) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.request = request;
	...
	public RolePagingUtilebackup(HttpServletRequest request, int totalCount, int currentPage, String search_keyword) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.request = request;
		this.search_keyword = search_keyword;
	...
	private void makePagination() {
		...
		if(this.search_keycode != null){
			if((this.currentPage ) == 0){
				...
				this.pagingHtmls.append("<a href='" + requestURI + "?currentPage=" + (this.currentPage -1 ) + "&search_keyword="+search_keyword + "&search_keycode="+search_keycode+" class=''><span>이전</span></a><span>");
			}
		}else{
			if((this.currentPage ) == 0){
				this.pagingHtmls.append("<a href='#' class='prev'><span></span></a><span>");
			}else{
				this.pagingHtmls.append("<a href='" + requestURI + "?currentPage=" + (this.currentPage -1 ) + "&search_keyword="+search_keyword + " class=''><span>이전</span></a><span>");
			}
		}
		...
		if(this.search_keycode != null){
			if((this.currentPage -1 ) < this.totalPage){
				this.pagingHtmls.append("</span><a href='" + requestURI + "?currentPage=" + (this.currentPage +1 ) + "&search_keyword="+search_keyword + "&search_keycode="+search_keycode+" class=''><span>다음</span></a></div>");
			...
			if((this.currentPage -1 ) < this.totalPage){
				this.pagingHtmls.append("</span><a href='" + requestURI + "?currentPage=" + (this.currentPage +1 ) + "&search_keyword="+search_keyword + " class=''><span>다음</span></a></div>");
